...
//           fwrite($flogra, $reg_logradouro);
        } else { echo ('Erro! : '.$reg_fornec.' - '.$id_pes_endereco.' - '.$id_pes_pessoa.$qp.'/'.$qm.'</p>'); // break;  
        }
      } 
     return $err;
}
